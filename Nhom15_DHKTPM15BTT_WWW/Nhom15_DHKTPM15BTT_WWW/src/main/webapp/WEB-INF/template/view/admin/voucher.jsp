             ...
             <c:param name="voucherId" value="${v.voucherId}" />
               ...
               <c:url var="deleteLink" value="/admin/deletevoucher">
                ...
                <tr>
                    ...
                    <td>${v.updateAt }</td>
                   <td>
                   <button class="badge badge-warning"  onclick="window.location.href='${updateLink}/admin/updatevoucher'; return false;" >Edit</button>
                   <button class="badge badge-warning" href="${deleteLink}" onclick="window.location.href='${deleteLink}/admin/deletevoucher';if (!(confirm('Are you sure you want to delete this Voucher?'))) return false">Delete</button></td>       
